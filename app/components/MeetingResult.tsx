  ...
  return (
    <div className="text-center space-y-6">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-5 py-3 bg-[var(--accent)] hover:bg-[var(--accent-light)] text-white font-semibold rounded-lg transition-colors"
      >
      ...
      <div className="flex flex-col items-center gap-3">
        {meetingAccount && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm text-[var(--accent-light)] hover:text-[var(--accent)] border border-[var(--border)] hover:border-[var(--accent)] rounded-lg transition-colors"
          >
        ...
        <div className="pt-2 border-t border-[var(--border)]">
          {teeVerified === null ? (
            <button
              ...
              disabled={verifying}
              className="w-full py-2 text-sm text-[var(--accent-light)] hover:text-[var(--accent)] border border-[var(--border)] hover:border-[var(--accent)] rounded-lg transition-colors disabled:opacity-50"
            >
